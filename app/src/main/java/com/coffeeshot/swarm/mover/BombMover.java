 ...
 */
public class BombMover extends Mover
{
  private long mLastTime;
  private boolean mJumble = true;
  ...
  public void run()
  {
    ...
    if (mRenderables != null)
    {
      ...
      for (int x = 0; x < mRenderables.size(); x++)
      {
        ...
        // Bounce.
        if ((object.x < mLeft && object.velocityX < 0.0f)
            || (object.x > mRight - object.width && object.velocityX > 0.0f))
        {
        ...
        if ((object.y < mTop && object.velocityY < 0.0f)
            || (object.y > mBottom - object.height && object.velocityY > 0.0f))
        {
